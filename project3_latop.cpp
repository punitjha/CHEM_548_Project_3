...
int main()
{
	...
	arma::vec k1=arma::linspace(-pi, pi, 100);		//wavefactor k1 defined as a vector
	...
	{	
		...
		for (int j=0; j<10 ; j++)
		{
//			if((( eigencarbon2(j) >= 0.8) && (eigencarbon2(j) <= 1.1)) ||  (( eigencarbon2(j) >= -0.8) &&  (eigencarbon2(j) <= -1.1)))
//			{
//				goto end1;
//			}
//			else
...
end1:
	...
	arma::cx_mat H_1(2,2); 							//this is the Hamiltonian matrix which has -1 at (0,0)
	arma::cx_mat H_2(2,2);							//this is the Hamiltonian matrix which has -1 at (0,1)
	arma::cx_mat H_antidiag(2,2);						//this is the anti-diagonal matrix
//	H_k1(0,0)=0;
////	H_k1(0,1)=-1-ex;
//	H_k1(0,0)=0;
//	H_k1(0,0)=0;
